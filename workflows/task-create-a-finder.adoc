...
. Nella scheda *attributi restituiti*, selezionare gli attributi richiesti per il filtro dall'elenco *disponibili* e fare clic su image:../media/right_arrow_button.gif["Pulsante freccia destra"].
